...
if __name__ == '__main__':
    ...
    #print(W)
    #W = [['network','search','caonima','he', 'as', 'no', 'in', 'you', 'at', 'it', 'of', 'on', 'am'],['netword','search','caonima','he', 'it', 'to', 'in', 'as', 'on', 'am', 'she', 'at', 'so'],['woshinidie','jingzeyu','liutingjie','in', 'of', 'he', 'do', 'so', 'and', 'to', 'no', 'or', 'as']]
    W=[['network','search'],['netword','search']]
