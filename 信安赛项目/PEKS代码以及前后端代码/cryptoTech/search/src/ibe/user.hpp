...
namespace Ibe {
	...
	class User {
		public:
			 ...
			 * @
			 */
			void extractPrivateKey( NFL_POLY_COEF_TYPE id) const noexcept;
			...
			void saveT(std::string filename) noexcept;
			void getT(std::string filename) noexcept;


			void saveX(std::string filename) noexcept;
			void getX(std::string filename) noexcept;

			void check() noexcept;
			void printX() noexcept;
